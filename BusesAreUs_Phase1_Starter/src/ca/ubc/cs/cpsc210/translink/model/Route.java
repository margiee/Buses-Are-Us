...
public class Route implements Iterable<Stop> {
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        } else if (this.getNumber().equals(((Route) o).getNumber())) {
            return true;
        } else {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        int result = routeNumber.hashCode();
        return result;
    }
    ...
    public RoutePattern getPattern(String patternName, String destination, String direction) {
        ...
        RoutePattern createRoutePattern = new RoutePattern(patternName, destination, direction, this);
        routePatterns.add(createRoutePattern);
    ...
    public RoutePattern getPattern(String patternName) {
        ...
        RoutePattern createRoutePattern = new RoutePattern(patternName, "", "", this);
        routePatterns.add(createRoutePattern);
        return createRoutePattern;
    }
